...
public class TestEuroBuletinSearch {

	private static final Logger LOGGER = LoggerFactory.getLogger(TestEuroBuletinSearch.class);
	...
	public void testBuildQueryComp() {
		try {
			EuroBuletinSearch search = new EuroBuletinSearch();
			
			search.setDatBuletinOt(new Date());
			//search.setDatBuletinDo(new Date());
