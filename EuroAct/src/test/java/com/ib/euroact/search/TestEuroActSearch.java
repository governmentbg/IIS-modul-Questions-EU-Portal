...
public class TestEuroActSearch {

	private static final Logger LOGGER = LoggerFactory.getLogger(TestEuroActSearch.class);
	...
	public void testBuildQueryComp() {
		try {
			EuroActNewSearch search = new EuroActNewSearch();
			search.setNomer(118);
