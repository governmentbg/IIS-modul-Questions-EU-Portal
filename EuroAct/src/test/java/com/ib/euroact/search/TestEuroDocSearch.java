...
public class TestEuroDocSearch {

	private static final Logger LOGGER = LoggerFactory.getLogger(TestEuroDocSearch.class);
	...
	public void testBuildQueryComp() {
		try {
			EuroDocSearch search = new EuroDocSearch();
			
			search.setSignSeria(7060);
			search.setSignGodina(2008);
			search.setSignNomer(898);
