...
public class ParseTest {
	...
	public void testParse() {
		...
		try {
			byte[] bytes = FileUtils.getBytesFromFile(new File("D:\\_zip\\аааааа\\COM_2021_17_transmission_sheet.xml"));
...
//            System.out.println("333="+(extension.get(0).getWorkflowNumber()==null));
//            System.out.println("444="+(extension.get(0).getWorkflowNumber().getCode()==null));
