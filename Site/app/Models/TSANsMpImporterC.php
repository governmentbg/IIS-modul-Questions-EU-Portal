 ...
 */
class TSANsMpImporterC extends Model
{
    use SoftDeletes;
    /**
     ...
     * @var string
     */
    protected $table = 'TS_A_ns_Mp_Importer_C';
     ...
     */
    protected $fillable = [
        'A_ns_MPI_id', 'A_ns_MP_id', 'A_ns_C_id', 'created_at', 'updated_at', 'deleted_at'
    ];
     ...
     */
    protected $casts = [
        'A_ns_MPI_id' => 'int', 'A_ns_MP_id' => 'int', 'A_ns_C_id' => 'int', 'created_at' => 'timestamp', 'updated_at' => 'timestamp', 'deleted_at' => 'timestamp'
    ];
